...
const projects = [
  ...
  },
  {
    ...
    description: "Site de portfólio moderno e responsivo desenvolvido com as mais recentes tecnologias web.",
  ...
  },
  {
    ...
    description: "Aplicação web para gerenciamento de cadastros com interface intuitiva e banco de dados robusto.",
    image: "/registration-system-interface.jpg",
  ...
  return (
    <section id="projetos" ref={sectionRef} className="py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 fade-in-item opacity-0">Projetos</h2>
